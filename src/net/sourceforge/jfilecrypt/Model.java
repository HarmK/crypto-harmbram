...
public class Model {
    ...
    private File targetArchive = null, targetDirectory = null; //the archive file when encrypting, the output directory when decrypting
    ...
    private void updateProgress() {
        ...
        //Application.getController().displayVerbose("Progress calculated: " + dprog);
            ...
            public void run() {
                ...
                for (int f = 0; f < fileList.size(); f++) {
                    ...
                    try {
                        ...
                        File outputDir = getTargetDirectory();//new File(archive.getAbsolutePath().substring(0, archive.getAbsolutePath().length()-alg.getSuffix().length())+"-decrypted/");
